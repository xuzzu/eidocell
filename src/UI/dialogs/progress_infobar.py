...
class ProgressInfoBar(QFrame):
    ...
    def __init__(self, icon: Union[InfoBarIcon, FluentIconBase, QIcon, str], title: str, content: str,
                 orient=Qt.Horizontal, isClosable=False, duration=1000, position=InfoBarPosition.TOP_RIGHT,
                 parent=None):
        """
        Parameters
        ----------
        ...
        self.progressBar = ProgressBar(self)  # Create the progress bar
        ...
        # Add widget layout to the horizontal layout
        ...
        # Add text and progress bar layout to the vertical layout
        self.vBoxLayout.addLayout(self.textLayout)
        self.vBoxLayout.addWidget(self.progressBar, 0, Qt.AlignTop | Qt.AlignLeft)
    ...
    def __initLayout(self):
        ...
        self.textLayout.setSizeConstraint(QVBoxLayout.SetMinimumSize)
        ...
        # Create a vertical layout for text and progress bar
        textProgressLayout = QVBoxLayout()

        # Add title and content to the text layout
        ...
        # Add text layout to the vertical layout
        textProgressLayout.addLayout(self.textLayout)

        # Add progress bar to the vertical layout
        textProgressLayout.addWidget(self.progressBar)

        # Add the vertical layout to the main horizontal layout
        self.hBoxLayout.addLayout(textProgressLayout, 1)

        # Add close button to layout
        self.hBoxLayout.addSpacing(12)
        self.hBoxLayout.addWidget(self.closeButton, 0, Qt.AlignTop | Qt.AlignRight)
    ...
    def __setQss(self):
        ...
        self.setCustomBackgroundColor('#d7f7ec', '#202020')
    ...
    def set_title(self, title: str):
        """Sets the title of the info bar."""
        self.title = title
    ...
    def set_content(self, content: str):
        """Sets the content text of the info bar."""
        self.content = content
    ...
    def new(cls, icon, title, content, orient=Qt.Horizontal, isClosable=True, duration=1000,
        ...
        w = ProgressInfoBar(icon, title, content, orient,
...
class InfoBarManager(QObject):
    ...
    _instance = None
    managers = {InfoBarPosition.TOP: TopInfoBarManager(),
    ...
    def __init__(self):
        ...
        self.slideAnis = []
        self.dropAnis = []
        # self.managers[InfoBarPosition.TOP] = TopInfoBarManager()
        # self.managers[InfoBarPosition.TOP_RIGHT] = TopRightInfoBarManager()
        # self.managers[InfoBarPosition.BOTTOM_RIGHT] = BottomRightInfoBarManager()
        self.__initialized = True

    def add(self, infoBar: ProgressInfoBar):
        """ add info bar """
    ...
    def remove(self, infoBar: ProgressInfoBar):
        """ remove info bar """
        p = infoBar.parent()
        if p not in self.infoBars:
            return
    ...
    def _createSlideAni(self, infoBar: ProgressInfoBar):
    ...
    def _pos(self, infoBar: ProgressInfoBar, parentSize=None) -> QPoint:
        """ return the position of info bar """
        raise NotImplementedError

    def _slideStartPos(self, infoBar: ProgressInfoBar) -> QPoint:
    ...
    def make(cls, position: InfoBarPosition):
        ...
        # Bottom right by default for progress tracking
...
class TopInfoBarManager(InfoBarManager):
    ...
    def _pos(self, infoBar: ProgressInfoBar, parentSize=None):
        p = infoBar.parent()
    ...
    def _slideStartPos(self, infoBar: ProgressInfoBar):
...
class BottomLeftInfoBarManager(InfoBarManager):
    ...
    def _pos(self, infoBar: ProgressInfoBar, parentSize: QSize = None) -> QPoint:
        p = infoBar.parent()
        parentSize = parentSize or p.size()
